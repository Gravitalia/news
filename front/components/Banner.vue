...
<template>
  ...
  >
    ...
    <div v-if="canClose" class="xl:mr-8 flex flex-1 justify-end">
      <button
        type="button"
        class="cursor-pointer -m-3 focus-visible:outline-offset-[-4px] bg-transparent border-none"
        @click="isClosed = true"
      >
        <span class="sr-only">Dismiss</span>
        <svg
          class="size-5 fill-zinc-200"
          viewBox="0 0 20 20"
          aria-hidden="true"
        >
          <path
